...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horizontally', '.main-prev-btn', '.main-next-btn');
...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      var dots;
      var method = item.files[0].name.split('.');
      ...
      var name = method[0].substring(0, 6) + dots + method[1];
...
var mask = function mask(selector) {
  ...
  function maskMake(event) {
    ...
    this.value = matrix.replace(/./g, function (a) {
      //функция выполнится для каждого найденного элемента в matrix.Вместо a - каждый символ матрицы
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        sendDataBtn = document.querySelector('[data-sendData]'),
        scroll = calcScroll();
  ...
  function giftByScroll(selector) {
